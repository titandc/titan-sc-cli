...
If you have only one company and no server is specified, company events are shown automatically.`,
	...
	historyEvent.Flags().StringP("company-oid", "c", "", "Company OID (auto-detected if you have only one company).")
